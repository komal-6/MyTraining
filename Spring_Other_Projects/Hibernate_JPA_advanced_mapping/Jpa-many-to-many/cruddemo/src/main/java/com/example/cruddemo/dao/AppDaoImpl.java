...
public class AppDaoImpl implements AppDao{
    ...
    @Override
    public Course findByCourseAndReviewsByCourseId(int id) {
    ...
    public Course findCourseAndStudentByCourseId(int id) {
        TypedQuery<Course> query = entityManager.createQuery("select c from Course c JOIN FETCH " +
                "c.students where c.id=:data", Course.class);
        query.setParameter("data",id);
        Course course = query.getSingleResult();
        return course;
    }
    ...
    public Student findCourseAndStudentByStudentId(int id) {
        TypedQuery<Student> query = entityManager.createQuery("select s from Student s JOIN FETCH " +
                "s.courses where s.id=:data", Student.class);
        query.setParameter("data",id);
